    ...
    <footer className="bg-charcoal border-t border-white/10 py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-heading font-black text-xl text-white uppercase tracking-widest">
              Baatz<span className="text-gold">.</span>
            </p>
            <p className="text-white/40 text-sm mt-1">
              Fahrzeugaufbereitung · Lackpflege · Keramik-Beschichtung · Detailing
            </p>
          </div>

          <div className="flex flex-wrap gap-6 text-sm font-heading font-bold uppercase tracking-wider text-white/50">
            {[
              ...
              <a key={label} href={href} className="hover:text-gold transition-colors">
                {label}
              </a>
            ))}
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="font-heading font-bold text-sm uppercase tracking-wider">Facebook</span>
            </a>
            <a
            ...
            >
              ...
              <span className="font-heading font-bold text-sm uppercase tracking-wider">Instagram</span>
            </a>
            <a
            ...
            >
              ...
              <span className="font-heading font-bold text-sm uppercase tracking-wider">YouTube</span>
            </a>
            <a
            ...
            >
              ...
              <span className="font-heading font-bold text-sm uppercase tracking-wider">TikTok</span>
            </a>
          </div>
        </div>
